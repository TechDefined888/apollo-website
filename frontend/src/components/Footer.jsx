      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-10 lg:px-14 py-20 md:py-28">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-14">
          <div className="md:col-span-5">
            <div className="tracking-eyebrow text-[color:var(--off-white)]/60">Apollo Builders</div>
            ...
            <p className="mt-6 max-w-md text-[color:var(--off-white)]/70 font-light">
          ...
          <div className="md:col-span-3">
            <div className="tracking-eyebrow text-[color:var(--off-white)]/60">Services</div>
          ...
          <div className="md:col-span-4">
            <div className="tracking-eyebrow text-[color:var(--off-white)]/60">Contact</div>
            <ul className="mt-6 space-y-3 text-[15px] font-light">
              ...
              <li className="text-[color:var(--off-white)]/70 pt-3">
                Melbourne&rsquo;s South &amp; South-Eastern suburbs, VIC
              </li>
            </ul>

            <div className="tracking-eyebrow text-[color:var(--off-white)]/60 mt-10">Service Areas</div>
            <p className="mt-6 text-[14px] leading-relaxed text-[color:var(--off-white)]/75">
              {suburbs.join(" · ")}
            </p>
          </div>
        </div>

        <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-[12px] tracking-[0.15em] uppercase text-[color:var(--off-white)]/55">
