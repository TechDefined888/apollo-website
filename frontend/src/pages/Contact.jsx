  ...
  return (
    <div data-testid="contact-page">
      ...
      <section className="pt-32 md:pt-44 pb-14 md:pb-20 mx-auto max-w-[1440px] px-6 md:px-10 lg:px-14">
        <div className="tracking-eyebrow text-[color:var(--gold-dark)]">Contact</div>
        ...
        <Reveal className="lg:col-span-7">
          {sent ? (
            <div data-testid="thanks" className="border-t border-b border-[color:var(--hair)] py-16">
              <div className="tracking-eyebrow text-[color:var(--gold-dark)]">Sent</div>
              ...
              <p className="mt-6 text-[color:var(--ink-soft)] font-light max-w-lg">
            ...
            <form onSubmit={submit} noValidate data-testid="enquiry-form" className="border-t border-[color:var(--hair)]">
              <div className="tracking-eyebrow text-[color:var(--gold-dark)] pt-8">Request a Quote</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                ...
                <label className="block pt-4">
                  <span className="tracking-eyebrow text-[color:var(--gold-dark)] block mb-1">Address / Suburb</span>
                  <input
                ...
                <label className="block pt-4 md:col-span-2">
                  <span className="tracking-eyebrow text-[color:var(--gold-dark)] block mb-1">Project Type *</span>
                  <select
                ...
                <label className="block pt-4 md:col-span-2">
                  <span className="tracking-eyebrow text-[color:var(--gold-dark)] block mb-1">Message *</span>
                  <textarea
              ...
              <div className="mt-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <p className="text-[12px] tracking-[0.15em] uppercase text-[color:var(--ink-soft)]">
        ...
        <Reveal className="lg:col-span-5" delay={0.05}>
          <div className="lg:pl-10 lg:border-l lg:border-[color:var(--hair)] pt-8">
            ...
            <ul className="mt-10 space-y-8">
              <li>
                <div className="tracking-eyebrow text-[color:var(--gold-dark)] mb-2">Call</div>
                <a
              ...
              <li>
                <div className="tracking-eyebrow text-[color:var(--gold-dark)] mb-2">Email</div>
                <a
              ...
              <li>
                <div className="tracking-eyebrow text-[color:var(--gold-dark)] mb-2">Serving</div>
                <div className="flex items-start gap-3">
                  <MapPin className="h-5 w-5 mt-1 text-[color:var(--gold-dark)]" strokeWidth={1.25} />
            ...
            <div className="mt-14">
              <div className="tracking-eyebrow text-[color:var(--gold-dark)] mb-4">Service Areas</div>
