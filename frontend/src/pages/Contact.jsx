...
export default function Contact() {
  ...
  return (
    <div
      ...
      className="bg-[color:var(--ink-black)] text-[color:var(--paper)]"
    >
      <SEO
      ...
      <section className="relative pt-16 md:pt-28 pb-24 md:pb-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1440px] px-6 md:px-10 lg:px-14">
          ...
          <p className="mt-10 max-w-xl text-[color:var(--paper)]/85 text-[16px] md:text-[17px] leading-[1.7]">
            ...
            renovations and bathroom renovations across Melbourne&rsquo;s
            South-East. Contact our team for a personalised quote and expert
            advice.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1440px] px-6 md:px-10 lg:px-14 pb-28 md:pb-40 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
        <Reveal className="lg:col-span-7">
          <form
            ...
            className="border-t border-[color:var(--paper)]/15"
          >
            {/* Honeypot */}
            <div
              aria-hidden="true"
            ...
            <div className="tracking-eyebrow text-[color:var(--gold)] pt-8">
              Request a Quote
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
              {[
                ...
                <label key={f.name} className="block pt-4">
                  <span className="tracking-eyebrow text-[color:var(--gold)] block mb-1">
                    {f.label}
                  </span>
        ...
        <Reveal className="lg:col-span-5" delay={0.05}>
          <div className="lg:pl-10 lg:border-l lg:border-[color:var(--paper)]/15 pt-8">
            ...
            <ul className="mt-12 space-y-10">
              <li>
                <div className="tracking-eyebrow text-[color:var(--gold)] mb-3">
                  Call
                </div>
                ...
                <a
                  ...
                  className="font-display text-3xl md:text-4xl link-under inline-flex items-center gap-4"
                >
                  <Phone
                    className="h-5 w-5"
                    strokeWidth={1.25}
              ...
              <li>
                ...
                <a
                  ...
                  className="font-display text-2xl md:text-3xl link-under inline-flex items-center gap-4"
                >
                  <Mail
                    className="h-5 w-5"
                    strokeWidth={1.25}
              ...
              <li>
                ...
                <div className="flex items-start gap-3">
                  <MapPin
                    className="h-5 w-5 mt-1 text-[color:var(--gold)]"
                    strokeWidth={1.25}
                  />
